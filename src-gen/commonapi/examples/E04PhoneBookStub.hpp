...
*/
#ifndef V0_COMMONAPI_EXAMPLES_E04_Phone_Book_STUB_HPP_
#define V0_COMMONAPI_EXAMPLES_E04_Phone_Book_STUB_HPP_
...
class E04PhoneBookStubAdapter
 ...
 public:
    ...
    virtual void firePhoneBookAttributeChanged(const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookStruct >& phoneBook) = 0;

    /**
     * Sends a selective broadcast event for phoneBookDataSet. Should not be called directly.
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void firePhoneBookDataSetSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookDataElementMap > &_phoneBookDataSet) = 0;
    virtual void sendPhoneBookDataSetSelective(const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookDataElementMap > &_phoneBookDataSet, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    ...
    void lockPhoneBookAttribute(bool _lockAccess) {
        if (_lockAccess) {
            phoneBookMutex_.lock();
        } else {
            phoneBookMutex_.unlock();
        }
    }
...
protected:
    ...
    std::recursive_mutex phoneBookMutex_;
};
...
public:
    ...
    virtual const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookStruct > &getPhoneBookAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// sets attribute with the given value and propagates it to the adapter
    virtual void firePhoneBookAttributeChanged(std::vector< ::commonapi::examples::E04PhoneBook::phoneBookStruct > _value) {
    auto stubAdapter = CommonAPI::Stub<E04PhoneBookStubAdapter, E04PhoneBookStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->firePhoneBookAttributeChanged(_value);
    }
    void lockPhoneBookAttribute(bool _lockAccess) {
        auto stubAdapter = CommonAPI::Stub<E04PhoneBookStubAdapter, E04PhoneBookStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
            stubAdapter->lockPhoneBookAttribute(_lockAccess);
    }
     ...
     */
    virtual void firePhoneBookDataSetSelective(const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookDataElementMap > &_phoneBookDataSet, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    /// retrieves the list of all subscribed clients for phoneBookDataSet
    ...
    virtual void sendPhoneBookDataSetSelective(const std::vector< ::commonapi::examples::E04PhoneBook::phoneBookDataElementMap > &_phoneBookDataSet, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) {
        auto stubAdapter = CommonAPI::Stub<E04PhoneBookStubAdapter, E04PhoneBookStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
...
#endif // V0_COMMONAPI_EXAMPLES_E04_Phone_Book_STUB_HPP_
