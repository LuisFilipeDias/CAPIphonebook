...
*/
#ifndef V0_COMMONAPI_EXAMPLES_E04_PHONE_BOOK_HPP_
#define V0_COMMONAPI_EXAMPLES_E04_PHONE_BOOK_HPP_
...
public:
    ...
    typedef std::unordered_map< ::commonapi::examples::E04PhoneBook::phoneNumberEnum, std::string, CommonAPI::EnumHasher< ::commonapi::examples::E04PhoneBook::phoneNumberEnum>> phoneNumberMap;
    struct phoneBookStruct : CommonAPI::Struct< std::string, std::string, std::string, std::string, std::string, phoneNumberMap> {
        ...
        phoneBookStruct()
        {
            ...
            std::get< 3>(values_) = "";
            std::get< 4>(values_) = "";
            std::get< 5>(values_) = phoneNumberMap();
        }
        phoneBookStruct(const std::string &_name, const std::string &_forename, const std::string &_organisation, const std::string &_address, const std::string &_email, const phoneNumberMap &_phoneNumber)
        {
            ...
            std::get< 5>(values_) = _phoneNumber;
        }
        ...
        inline const phoneNumberMap &getPhoneNumber() const { return std::get< 5>(values_); }
        inline void setPhoneNumber(const phoneNumberMap &_value) { std::get< 5>(values_) = _value; }
        inline bool operator==(const phoneBookStruct& _other) const {
        return (getName() == _other.getName() && getForename() == _other.getForename() && getOrganisation() == _other.getOrganisation() && getAddress() == _other.getAddress() && getEmail() == _other.getEmail() && getPhoneNumber() == _other.getPhoneNumber());
        }
        inline bool operator!=(const phoneBookStruct &_other) const {
            return !((*this) == _other);
        }
    ...
    /*
     * description: 
     * Data types for the filter operations
     */
    ...
    struct contentFilterStruct : CommonAPI::Struct< phoneBookDataElementEnum, std::string> {
        ...
        contentFilterStruct()
        {
            std::get< 0>(values_) = phoneBookDataElementEnum();
            std::get< 1>(values_) = "";
        }
    ...
    static const CommonAPI::Serial PHONEBOOKDATAELEMENT_SERIAL = 0x3CAC80E3;
    static const CommonAPI::Serial PHONEBOOKDATAELEMENTSTRING_SERIAL = 0x48D343B7;
    static const CommonAPI::Serial PHONEBOOKDATAELEMENTPHONENUMBER_SERIAL = 0x2F0A9BFB;
    
    struct phoneBookDataElement : CommonAPI::PolymorphicStruct {
        static COMMONAPI_EXPORT std::shared_ptr< phoneBookDataElement> create(CommonAPI::Serial _serial);
    ...
    struct phoneBookDataElementPhoneNumber : phoneBookDataElement {
        ...
        : phoneBookDataElement()
        {
            std::get< 0>(values_) = phoneNumberMap();
        }
    ...
    typedef std::unordered_map< ::commonapi::examples::E04PhoneBook::phoneBookDataElementEnum, std::shared_ptr<phoneBookDataElement>, CommonAPI::EnumHasher< ::commonapi::examples::E04PhoneBook::phoneBookDataElementEnum>> phoneBookDataElementMap;
};

const char* E04PhoneBook::getInterface() {
    return ("commonapi.examples.E04PhoneBook:v0_0");
}
...
/*
 * description: 
 * Data types of the phone book itself
 */
/*
 * description: 
 * Data types for the filter operations
...
/*
 * description: 
 * Data types for the result of the phone book filter
 */
...
#endif // V0_COMMONAPI_EXAMPLES_E04_PHONE_BOOK_HPP_
